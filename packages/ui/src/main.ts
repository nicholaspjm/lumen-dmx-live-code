...
// ch1 = wash A dimmer, ch2-4 = wash A RGB
// ch5 = wash B dimmer, ch6-8 = wash B RGB
// ch9 = strobe, ch10 = spot
...
setInterval(() => {
  ...
  // wash A: ch1 dim, ch2-4 RGB
  updateGlobe(simWashA, ch[0], ch[1], ch[2], ch[3]);
  // wash B: ch5 dim, ch6-8 RGB
  updateGlobe(simWashB, ch[4], ch[5], ch[6], ch[7]);
  // spot: ch10, white light
  updateGlobe(simSpot, ch[9], 255, 240, 210);
  // strobe: ch9, white flash
  updateGlobe(simStrobe, ch[8], 255, 255, 255);
}, 33); // ~30fps
